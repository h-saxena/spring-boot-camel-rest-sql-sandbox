 ...
 */
package io.fabric8.quickstarts.camel.service;

import org.springframework.stereotype.Component;

import io.fabric8.quickstarts.camel.model.Order;
...
public class OrderService {
    ...
    public Order generateOrder() {
        ...
        order.setDescription(counter.get() % 2 == 0 ? "Camel in Action" + counter.get() : "ActiveMQ in Action"+counter.get());
        return order;
    }
